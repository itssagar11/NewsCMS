...
glyphicon glyphicon-sort-by-attributes set"style="float:right; color:#ffffff; background-color: #000000; margin:4px; padding:8px;" id="setting"></button	>
		 <button class="btn btn-success btn-md " id="published" style="float:right; margin:4px;">Published</button>
		 ...
		 <div class="flex-container">
		 	<div class="article">
		 		<textarea class=" at article_title" placeholder="Add Title" id="title"></textarea>
		 		<textarea class="article_title description" placeholder="Enter Meta Description within 255 words" id="MetaDescription" rows="50"></textarea>
		 	...
		 	<div class="setting">
		 		<div class="item">
			 		<form id="myImage">
			 			...
			 			<img src="https://img.freepik.com/free-photo/abstract-surface-textures-white-concrete-stone-wall_74190-8184.jpg?size=626&ext=jpg" width="100%" height="220px" id="showImg">
			 			<input type="file" id="image" name="myimage">
			 			<input type="text" class="featuredimageURL featuredImg" style="background-color:#ffffff; border:none;" id="featuredimage" disabled >
			 			<small id="msg"></small>
        		...
        		<option value="<?php echo $row["name"]; ?>"><?php echo $row["name"]; ?></option>
		 		...
		 		<input type="text" id="author"  readonly class="form-control"  value="<?php echo $user['Name'];?>">
		 		</div>
		 		<div class="item">
...
document.getElementById("date").value = n;	
	$(document).ready(function(){
    	...
    	$("#published").click(function(){
    		...
    		console.log(content);
    		$.ajax({
    			url:'admin/Article/addnews.php',
    			type:'POST',
    			data:{title:title,description:description,editor:content,featuredimage:featuredimage,keyword:keyword,category:category,author:author,date:date,location:location},
    			success:function(response){
    				if(response==-1){
    					...
    					console.log(response);
    						...
    						$("#alert").html("<div class='alert ' id='alert'><h4 style='color:#319400;'>Success</h4><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <div class='content'> Article Pubished. Readirecting You...</div></div></div>");
