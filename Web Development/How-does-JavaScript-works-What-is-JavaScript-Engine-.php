...
<html ⚡ lang="en">
  <head>
    ...
    <title>How does JavaScript  works? What is JavaScript Engine.</title>
    <link rel="canonical" href="http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-" />
    ...
    <link rel="amphtml" href="http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-" />
    <meta
      data-rh="true"
      name="title"
      content="How does JavaScript  works? What is JavaScript Engine."
    />
    <meta
      data-rh="true"
      name="description"
      content="JavaScript is a client-side scripting language and one of the most efficient, commonly used scripting languages. The term .client-side scripting language means that it runs at the client-side( or on the client machine) inside the web-browsers, but one important thing to remember is that client\'s web-browser also needs to support the JavaScript or it must be JavaScript enabled."
    />
    ...
    <meta
      ...
      content="https://sagarbisht.com/admin/images/1329860235.jpg"
    />
    ...
    <meta data-rh="true" property="og:url" content="http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-" />
    <meta data-rh="true" name="parsely-link" content="http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-" />
    ...
    <meta
      ...
      content="JavaScript is a client-side scripting language and one of the most efficient, commonly used scripting languages. The term .client-side scripting language means that it runs at the client-side( or on the client machine) inside the web-browsers, but one important thing to remember is that client\'s web-browser also needs to support the JavaScript or it must be JavaScript enabled."
    />
    <meta name="keywords" content="how javascript work, javascript, javascript engine">
    ...
    <script data-rh="true" type="application/ld+json">
      {
        ...
        "@type": "Article",
        "headline": "How does JavaScript  works? What is JavaScript Engine.",
        "datePublished": "112-7-2021",
        "url": "http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-",
        "name": "SagarBisht",
        "description": "JavaScript is a client-side scripting language and one of the most efficient, commonly used scripting languages. The term .client-side scripting language means that it runs at the client-side( or on the client machine) inside the web-browsers, but one important thing to remember is that client\'s web-browser also needs to support the JavaScript or it must be JavaScript enabled.",
      ...
      <div class="container">
        <div class="article-container">
          <amp-img
            ...
            height="500"
            layout="responsive"
            src="https://sagarbisht.com/admin/images/1329860235.jpg"
          ></amp-img>
          ...
          <h1 style="line-height:1.2; margin:1px;">
            How does JavaScript  works? What is JavaScript Engine.
          </h1>
...
></amp-social-share><br>
  ...
  data-param-url="http://sagarbisht.com/Web Development/How-does-JavaScript-works-What-is-JavaScript-Engine-"
...
>
          ...
          <article style="font-size:18px;">
             ...
             <p>JavaScript is a client-side scripting language and one of the most efficient, commonly used scripting languages. The term .<strong>client-side scripting language means</strong> that it runs at the client-side( or on the client machine) inside the web-browsers, but one important thing to remember is that client's web-browser also needs to support the JavaScript or it must be JavaScript enabled. Nowadays, most of the modern <a href="https://www.javatpoint.com/browsers">web browsers</a> support JavaScript and have their JavaScript engines. For example, Google Chrome has its own <a href="https://www.javatpoint.com/javascript-tutorial">JavaScript</a> engine called V8.</p><p>It totally depends on the web-developers how they use JavaScript and for what, because it can be used for several things in web development. One of the most common uses of JavaScript is to validate data given by the user in the form fields.</p><p><strong>Here another question that comes out "how the browser understands the JavaScript code and runs it."</strong></p><p>Mostly every web browsers nowadays have their own JavaScript engines, as we have discussed above. So, it is the JavaScript engine that understands the code and runs it.</p><p>Now let's see how the JavaScript engine handles and runs .js code.</p><p>In this case, we have used a <a href="https://www.javatpoint.com/google-chrome">chrome browser</a> to run our program that has the "V8" JavaScript engine, which is also used for creating the <a href="https://www.javatpoint.com/nodejs-tutorial">Node.js</a>. As we already know, JavaScript is an interpreted language that means it gets executed in line by line manner (or which means the JavaScript engine converts the Js code line by line and runs in the same manner instead of converting the whole program once).</p><p>We can understand how a typical JavaScript engine works with help of a diagram:</p><p>&nbsp;</p>
        ...
        <div class="sidebar-container">
          ...
          <amp-list
            ...
            height="500"
            layout="fixed-height"
            src="//sagarbisht.com/JSON/related.php?id=250"
          >
            <template type="amp-mustache">
              <div class="related">
      ...
      <div>
        ...
        <amp-list
          ...
          height="1200"
          layout="responsive"
          src="//sagarbisht.com/JSON/News/article.php?id=250"
          binding="refresh"
        >
          <template type="amp-mustache">
            <div class="more-news">
